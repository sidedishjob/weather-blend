              ...
              <CardContent className="p-4 lg:p-6">
                <div className="relative w-full aspect-[6/5] lg:aspect-[4/3] bg-gradient-to-b from-sky-100 to-blue-100 rounded-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-20">
                    <div
                      className="absolute top-[20%] left-[10%] w-32 h-32 border border-blue-300 rounded-full animate-ping"
                      style={{ animationDuration: "4s" }}
                    ></div>
                    <div
                      className="absolute top-[60%] right-[15%] w-24 h-24 border border-blue-300 rounded-full animate-ping"
                      style={{
                  ...
                  {/* 本州 */}
                  <div
                    className="absolute top-[25%] left-[38%] w-[30%] h-[40%] bg-gradient-to-br from-green-300/80 via-green-400/70 to-green-500/60 transform -rotate-6 shadow-lg"
                    style={{
                      borderRadius: "60% 40% 30% 70% / 60% 30% 70% 40%",
                    }}
                  >
                    <div
                      className="absolute inset-2 bg-gradient-to-br from-green-200/60 to-green-300/40"
                      style={{
                        borderRadius: "60% 40% 30% 70% / 60% 30% 70% 40%",
                      }}
                    ></div>
                  ...
                  {/* 四国 */}
                  <div
                    className="absolute top-[58%] left-[42%] w-[13%] h-[12%] bg-gradient-to-br from-green-300/80 via-green-400/70 to-green-500/60 transform rotate-3 shadow-md"
                    style={{
                      borderRadius: "50% 60% 40% 50% / 40% 60% 50% 40%",
                    }}
                  >
                    <div
                      className="absolute inset-1 bg-gradient-to-br from-green-200/60 to-green-300/40"
                      style={{
                        borderRadius: "50% 60% 40% 50% / 40% 60% 50% 40%",
                      }}
                    ></div>
                  ...
                  {/* 九州 */}
                  <div
                    className="absolute top-[65%] left-[25%] w-[16%] h-[18%] bg-gradient-to-br from-green-300/80 via-green-400/70 to-green-500/60 transform rotate-8 shadow-md"
                    style={{
                  ...
                  {/* 雲の影 */}
                  <div
                    className="absolute top-[15%] left-[20%] w-16 h-8 bg-gray-300/20 rounded-full blur-sm animate-pulse"
                    style={{ animationDuration: "8s" }}
                  ></div>
                  <div
                    className="absolute top-[70%] right-[10%] w-12 h-6 bg-gray-300/20 rounded-full blur-sm animate-pulse"
                  ...
                  {majorCities.map((city) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* 都市情報カード */}
                        <div
                          className={`relative glass-card border-blue-300/60 p-1.5 lg:p-2 min-w-[65px] lg:min-w-[75px] transition-all duration-300 ${
                        ...
                        >
                          <div className="text-center space-y-1">
                            <div className="flex items-center justify-center">
                              <IconComponent
                                className={`w-2.5 h-2.5 lg:w-3.5 lg:h-3.5 ${getWeatherColor(
                                  city.weather
                                )}`}
                              />
                            </div>
                ...
                <CardContent className="p-4 lg:p-6">
                  <div className="text-center space-y-4">
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      <selectedCityData.icon
                        className={`w-12 h-12 lg:w-16 lg:h-16 ${getWeatherColor(
                          selectedCityData.weather
                        )}`}
                      />
                      <div className="text-left">
                        <div
                          className={`text-3xl lg:text-4xl font-bold ${getTemperatureColor(
                            selectedCityData.temp
                          )}`}
                        >
